...
public class MagicValue {
    ...
    public static final String EM_STYLE_TAG = "em";
    ...
    public static final String TWIG_LANGUAGE_ID = "Twig";
    ...
    public static final String TO_EM_TIP = " to em";

    public static final String TO_VW_TIP = " to vw";

    public static final String TO_VH_TIP = " to vh";

    public static final String[] TO_RWD_TIPS = new String[]{TO_VW_TIP, TO_EM_TIP, TO_VH_TIP, TO_REM_TIP};

    public static final String[] RWD_TIPS = new String[]{REM_STYLE_TAG, EM_STYLE_TAG, VW_STYLE_TAG, VH_STYLE_TAG, };
    ...
    public static final Map STYLE_TAG_TYPE = LogicUtils.getLogic().generateObject(new HashMap<>(), map ->
            ...
            map.put(ShortCutType.EM, EM_STYLE_TAG), map ->
